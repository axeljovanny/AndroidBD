...
public class OrderDB extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(String.format("CREATE TABLE %s (%s INTEGER PRIMARY KEY" +
                ...
                Tables.ENGLISH, BaseColumns._ID,
                OrderContract.English.ID,
                OrderContract.English.VALUE,
                OrderContract.English.ABBREVIATION,
                OrderContract.English.SPELLING));
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS "+Tables.ENGLISH);
